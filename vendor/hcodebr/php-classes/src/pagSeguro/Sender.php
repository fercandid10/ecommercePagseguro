...
class Sender {
    ...
    public function __contruct(string $name, Document $cpf, DateTime $bornDate, Phone $phone, string $email, string $hash){
        ...
        if (filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            throw new Exception("O e-mail informado nao é valido.");
            
        }

        if (!$hash){

            throw new Exception("Informe a identificaçao do comprador.");
